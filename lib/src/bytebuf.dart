...
//TODO: edit comment
/// A library for reading values from a [Uint8List], aka [ByteArray]
///
...
class ByteArray {
  ...
  int position;
  //TODO: get rid of limit; just use a new ByteArray instead
  //int limit;

  /// Constructor
  ByteArray(Uint8List bytes, [start = 0, end])
    ...
    if ((start + length) > bytes.lengthInBytes)
      throw "Invalid indexes (start= $start, end=$end)"
  ...
  ByteArray sublist(int start, [int end]) => new ByteArray(bytes, start, end);
